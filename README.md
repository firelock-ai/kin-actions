...
`firelock-ai/kin-actions/.github/workflows/cargo-registry-release.yml@v0.1.28`.
...
- `.github/workflows/public-history-hygiene.yml`
  ...
  jobs:
    hygiene:
      uses: firelock-ai/kin-actions/.github/workflows/public-history-hygiene.yml@v0.1.28
  ```
