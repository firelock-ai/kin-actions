...
`firelock-ai/kin-actions/.github/workflows/cargo-registry-release.yml@v0.1.35`.
...
- `.github/workflows/public-history-hygiene.yml`
  ...
  jobs:
    hygiene:
      uses: firelock-ai/kin-actions/.github/workflows/public-history-hygiene.yml@v0.1.35
  ```
...
- `.github/workflows/scheduled-failure-alarm.yml`
  ...
  jobs:
    alarm:
      uses: firelock-ai/kin-actions/.github/workflows/scheduled-failure-alarm.yml@v0.1.35
  ```
