...
1. Go to the **Security** tab of [firelock-ai/kin-actions](https://github.com/firelock-ai/kin-actions/security).
...
This policy covers the `kin-actions` repository: the shared GitHub Actions
reusable workflows and release tooling for Kin's cargo-registry publishing and
dependency-wave automation. Other Kin ecosystem repositories (for example
